(function($) {
    ...
    var slide = function(ele,options) {
        ...
        var states = [
            ...
            { $zIndex: 6, width: 224, height: 288, top: 0, left: 263, $opacity: 1 },
            { $zIndex: 7, width: 224, height: 288, top: 0, left: 263, $opacity: 1 },
            { $zIndex: 6, width: 224, height: 288, top: 0, left: 263, $opacity: 1 },
            { $zIndex: 5, width: 224, height: 288, top: 0, left: 263, $opacity: 1 },
...
uranus.hover(function () {
    hiddenTitle.text("سیاره اورانوس");
    hiddenContent.text('هفتمین سیاره از نظر نزدیکی به خورشید و سومین سیاره از نظر اندازه و چهارمین سیاره از نظر جرم در سامانهٔ خورشیدی است. اورانوس هر ۸۴ سال و ۷ روز یک بار به دور خورشید می‌گردد. همچنین هر ۱۰ ساعت و ۴۸ دقیقه یک دور به دور خودش می‌چرخد. اورانوس دارای بیش از ۲۷ ماه است بزرگترین آنها به نام‌های میراندا، آریل، آمبریل، تیتانیا و ابرون است. این سیاره را ویلیام هرشل در سال ۱۷۸۱ میلادی کشف کرداورانوس یکی از سیارات هشتگانه منظومه شمسی که از لحاظ بعد فاصله اش نسبت به خورشید در ردیف هفتم پس از زحل قرار گرفته‌است. فاصله متوسط این سیاره تا خورشید۲٬۸۶۹٬۶۰۰٬۰۰۰ کیلومتر و 14.5 بار از کره زمین بزرگ‌تر است. اورانوس ۲۷ ماه طبیعی دارد. این سیاره با چشم غیرمسلح دیده می‌شود. محور حرکت وضعی این سیاره کاملاً با مدار حرکت انتقالیش منطبق است. سفرهای اکتشافی به این سیاره کمتر از ده مأموریت بوده که شاخصترینش مأموریت ویجر ۲ بود که این فضاپیما در ژانویه ۱۹۸۶ به آن رسید.. ');
    hiddenImage.attr('src','./image/uranus.jpg');
    imageLink.attr('href','https://fa.wikipedia.org/wiki/%D8%A7%D9%88%D8%B1%D8%A7%D9%86%D9%88%D8%B3#cite_note-pat2-14');

  });

//اسلاید نهم مریخ
mercury.hover(function () {
    hiddenTitle.text("سیاره عطارد");
    hiddenContent.text('سیاره عطارد با فاصلهٔ ۵۷ میلیون و ۹۲۴ هزار کیلومتری از خورشید، نزدیکترین سیاره منظومه شمسی به خورشید است و کم‌ترین مسافتی که با زمین پیدا می‌کند، به ۸۰ میلیون کیلومتر می‌رسد. به خاطر نزدیکی این سیاره به خورشید اگر در طرف رو به خورشید آن قرار بگیرید به راحتی در دمای ۴۶۵درجه سانتیگراد پخته خواهید شد و به علت حرکتی وضعی آرامش اگر در طرف شب آن قرار بگیرید آن قدر سرد خواهد شد که در دمای ۱۴۸- درجه سانتیگراد به راحتی مرگ را بر اثر یخ بستن تجربه می‌کنید. گردش وضعی این سیاره، حدود دو ماه طول می‌کشد و از این رو، گرم شدن آن در روز و سرد شدنش در شب دیرپاست و همین باعث فرسایش خاک عطارد می‌شود.حفره‌های کوچک ویا بزرگ بسیاری در سطح سیارهٔ عطارد دیده می‌شود که حکایت از برخورد شهاب ‌سنگ‌های کوچک و بزرگ دارد البته قطر برخی از دهانه‌ها به ده‌ها کیلومتر می‌رسد. برخی از این دهانه‌ها محل خروج مواد مذاب است که امروزه با سنگهای مذاب پر شده‌اند و مانند کوه‌های آتشفشانی هستند. سطح عطارد بیشتر خاکستری‌رنگ است و به خاطر نوع دهانه‌های آتشفشانی و آبگیرها بسیار شبیه کره ماه است. دانشمندان تصور می‌کردند که فعالیت‌های آن مانند کره ماه‌است. اما اکنون می‌دانیم که سیاره عطارد با کره ماه بسیار متفاوت است. عطارد کوه و آتشفشان‌های بزرگ و عمده‌ای ندارد و از نظر فعالیت‌های زمین‌شناختی سیاره‌ای مرده به‌شمار می‌آید.');
    hiddenImage.attr('src','./image/mercury.gif');
    imageLink.attr('href','https://fa.wikipedia.org/wiki/%D8%B9%D8%B7%D8%A7%D8%B1%D8%AF');

  });

//اسلاید دهم زحل
saturn.hover(function () {
    hiddenTitle.text("سیاره زحل");
    hiddenContent.text('زُحَل یا کِیوان پس از مشتری، دومین سیارهٔ بزرگ منظومه شمسی و ششمین سیاره نزدیک به خورشید است. زحل یک گلوله گازی غول‌پیکر است که با وجود حجم زیادش تنها ۹۵ برابر زمین جرم دارد. چگالی این سیاره حدود یک‌هشتم زمین و کمتر از آب است. یک روز کامل در کیوان برابر ۱۰ ساعت و ۳۹ دقیقه در زمین و یک سال آن برابر ۲۹٫۵ برابر سال زمین است. از آنجایی که مدار استوایی زحل تقریباً همانند زمین در ۲۷ درجه‌است، تغییرات زاویه سیاره نسبت به خورشید شبیه به زمین است و در این سیاره نیز همان چهار فصل مشاهده می‌شود. جرم سیاره زحل همانند مشتری از گاز است که بیشتر آن را هیدروژن تشکیل می‌دهد. میزان اندکی هلیوم و متان در رده‌های بعدی گازهای تشکیل‌دهندهٔ سیاره قرار دارند. در آسمان شب زمین، زحل به دلیل اندازه بزرگ، نسبتاً درخشان دیده می‌شود. زیبایی آسمان زحل به خاطر نوارهای روشن حلقه‌های اطراف آن و نیز به خاطر قمرهای زیادش است.به علت سرعت حرکت کیوان به دور خود در قطب‌های آن نوعی حالت پخی مشاهده می‌شود که سیاره را از شکل کرهٔ کامل دور می‌کند. زحل از جنبه‌های زیادی شبیه مشتری است، جز اینکه در اطراف آن چندین حلقه شگفت‌انگیز وجود دارد.');
    hiddenImage.attr('src','./image/saturn.png');
    imageLink.attr('href','https://fa.wikipedia.org/wiki/%D8%B2%D8%AD%D9%84');

  });

//اسلاید یازدهم نپتون
neptune.hover(function () {
    hiddenTitle.text("سیاره نپتون");
    hiddenContent.text('هشتمین و آخرین سیارهٔ سامانه خورشیدی. این نام به عنوان خدای دریا و همزاد اورانوس نامگذاری شده‌است. نپتون چهارمین سیاره از نظر اندازه و سومین سیاره از نظر جرم است. نپتون، چهارمین جسم در سامانه خورشیدی بر پایهٔ جرم و حجم می‌باشد.کشف این سیاره در بین سال‌های ۱۷۹۰ تا ۱۸۴۰ بر اثر اختلالاتی که در مدار اورانوس مشاهده شد، انجام گردید. این سیاره هر ۱۶۳/۷ سال یک بار دور خورشید می‌چرخد معمولاً همهٔ انسان‌های روی زمین این سیاره را به رنگ آبی می‌شناسند. این رنگ را گاز متان حاضر در جو نپتون که رنگ سرخ را جذب می‌کند و آبی‌حاصل از طیف نوری خورشید که بازتابیده می‌شود پدید می‌آید نپتون از نظر ساختاری بسیار شبیه به سایر سیارات گازی به خصوص اورانوس است. تفاوتی که در ساختار سیاره‌هایی مانند اورانوس و نپتون دیده می‌شود، به سبب عدم حضور هیدروژن فلزی مایع است که در عوض آن یک ساختار متراکم آب مانندی در اطراف هسته وجود دارد. لایهٔ بیرونی‌تر نپتون متشکل از هیدروژن ملکولی مایع و هلیوم مایع استاتمسفر و جو نپتون آبی رنگ است و درصد بازتابش بالائی دارد که حاکی از وجود یک جو غلیظ است. برابر با نتیجهٔ بررسی‌ها حضور مقداری متان نیز در این سیاره تأیید شده‌است. در کل، ترکیبات جو این سیاره به مانند سایر سیارات غول پیکر گازی شامل ۸۰ تا ۸۵ درصد هیدروژن و ۱۵ تا ۱۹ درصد هلیوم است');
    hiddenImage.attr('src','./image/neptune.gif');
    imageLink.attr('href','https://fa.wikipedia.org/wiki/%D9%86%D9%BE%D8%AA%D9%88%D9%86');
